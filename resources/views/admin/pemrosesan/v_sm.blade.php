    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="card mt-3">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <a href="{{ url('surat-masuk/insert') }}" class="btn btn-sm btn-primary"><i class="fas fa-file-upload"></i> Surat Masuk Baru</a>
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $sm->disposisi }}</td>
                  <td>
                    <a href="{{ url('surat-masuk/detail/' . $sm->id) }}" title="Lihat" class="btn btn-sm btn-secondary"><i class="fas fa-eye"></i></a>
                    @if(auth()->user()->level == 'sekretaris' || auth()->user()->level == 'admin')
                    <a href="{{ url('surat-masuk/' . $sm->id ) }}" title="Edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                    <form action="{{ url('surat-masuk/' . $sm->id) }}" method="post" class="d-inline destroy">
                      @csrf
