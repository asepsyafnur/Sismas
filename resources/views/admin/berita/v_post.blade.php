...
@section('title', 'Ippmp | post berita')
@section('link')
<!-- DataTables -->
                            ...
                            <form action="{{ url('admin/post-berita')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="judul" class="form-control" name="tulisan_judul" id="judul" placeholder="Masukkan Judul" value="{{ old('tulisan_judul') }}" />
                                        @error('tulisan_judul')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <textarea class="form-control" name="tulisan_isi" id="isi" cols="30" rows="10">{{old('tulisan_isi')}}</textarea>
                                        @error('tulisan_isi')
                                        <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12 position-relative">
                                                <label for="gambar" class="mb-3">Gambar</label>
                                                <span class="text-primary" style="font-size: 13px; position:absolute; top:1.2rem; left:10px;">*disarankan ukuran gambar 710x460</span>
